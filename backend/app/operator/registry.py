...
ACTION_REGISTRY: dict[str, ActionSpec] = {
    ...
    "import_jobs_to_application_table": _action(
        ...
        effect_specs=(
            ...
            EffectSpec("patch", "application_record", visibility="supporting", description="Maintain is_duplicate/duplicate_group on pre-existing records whose signature collides with imported rows."),
        ),
        risk=4,
    ...
    "auto_write_application_content": _action(
        ...
        side_effects=(
            ...
            "create:application_workspace_settings",
            "create:application_template",
            "create:application_table",
            "patch:application_table",
            "create:application_table_record",
            "patch:application_record",
        ),
        effect_specs=(
            EffectSpec("create", "application_record", visibility="public"),
            EffectSpec("create", "application_workspace_settings", visibility="supporting"),
    ...
    "optimize_resume": _action(
        ...
        implemented=False,
        non_operable_reason="Resume optimization LLM pipeline is not wired yet; use generate_resume instead.",
    ),
    "batch_optimize_resume": _action(
        ...
        implemented=False,
        non_operable_reason="Batch resume optimization LLM pipeline is not wired yet; use generate_resume instead.",
    ),
    ...
    "ensure_application_for_job": _action(
        ...
        effect_specs=(
            EffectSpec("create", "application", visibility="public"),
            EffectSpec("create", "application_record", visibility="public"),
            EffectSpec("create", "application_workspace_settings", visibility="supporting"),
            EffectSpec("create", "application_template", visibility="supporting"),
            EffectSpec("create", "application_table", visibility="supporting"),
            EffectSpec("patch", "application_table", visibility="supporting"),
            EffectSpec("create", "application_table_record", visibility="supporting"),
            EffectSpec("patch", "application_record", visibility="supporting", description="Maintain is_duplicate/duplicate_group on pre-existing records whose signature collides with imported rows, and bind application_id/apply_status on the job's projection records."),
        ),
        risk=2,
        result_model="application",
        cost=1,
...
SKILL_REGISTRY: dict[str, SkillSpec] = {
    "resume-optimizer": _skill(
        ...
        allowed_write_actions=("generate_resume",),
    ...
    "profile-cleanup": _skill(
        "profile-cleanup",
        "Profile cleanup",
        "Clean and consolidate profile facts.",
        ("Clean up my profile", "Organize my profile facts"),
        ("profile_id",),
        ("profile",),
        allowed_write_actions=("profile_agent_apply_patch",),
    ),
